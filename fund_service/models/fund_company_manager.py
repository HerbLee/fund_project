...
FundCompanyManagerModel = sa.Table(
    'fund_company_manager', metadata,
    ...
    sa.Index('idx_fund_company_manager_comid', 'company_id', unique=True),
    sa.Index('idx_company_manager_maid', 'manager_id', unique=True),
    comment='基金公司和基金经理关联表'
)


class FundCompanyManagerSchema(Schema):
    id = fields.Integer()
